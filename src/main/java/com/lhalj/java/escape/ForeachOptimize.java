...
public class ForeachOptimize {
    ...
    private static Collection<Integer> left = Arrays.asList(1,2,23,3,22,32,11,2322);
    private static Collection<Integer> right = Arrays.asList(1,21,23,3,22,2,11,2322);
     ...
     * 集合迭代经常犯的错误
     */
    private static void mrongIterator(){
